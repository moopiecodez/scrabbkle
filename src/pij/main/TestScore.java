...
public class TestScore {
    ...
    public void wordLetterScoring() {
        ...
        int actualWordLetterScore = Score.letterScoring(word);
    ...
    public void fullWordMultiplier() {
        ...
        int actualFullWordMultiplier = Score.fullWordMultiplier(word);
    ...
    public void wordScore() {
        ...
        int actualFullWordScore = Score.wordScoring(word);
